...
function listByFilters() {
	...
	let requestString = "http://localhost:8080/Perfume/getByFilters?";
	...
	let sortingType = document.querySelector(
...
function listAll() {
	$.getJSON("http://localhost:8080/Perfume/getAll", function (data) {
		var table = document.getElementById("table");
...
function listBrands() {
	$.getJSON("http://localhost:8080/Perfume/getBrands", function (data) {
